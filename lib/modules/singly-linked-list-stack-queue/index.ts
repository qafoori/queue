import { SinglyLinkedListStack } from 'lifoer'

import { Queue } from '../../types'

export class SinglyLinkedListStackQueue<T> implements Queue<T> {
  private readonly enqueueStack: SinglyLinkedListStack<T>
  private readonly dequeueStack: SinglyLinkedListStack<T>

  constructor() {
    this.enqueueStack = new SinglyLinkedListStack<T>()
    this.dequeueStack = new SinglyLinkedListStack<T>()
  }
  ...
  toString(): string {
    return 'SinglyLinkedListStackQueue'
  }
}
