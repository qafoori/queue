import { ArrayStack } from 'lifoer'

import { Queue } from '../../types'

export class ArrayStackQueue<T> implements Queue<T> {
  private readonly enqueueStack: ArrayStack<T>
  private readonly dequeueStack: ArrayStack<T>

  constructor() {
    this.enqueueStack = new ArrayStack<T>()
    this.dequeueStack = new ArrayStack<T>()
  }
