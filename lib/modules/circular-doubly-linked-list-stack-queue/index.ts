import { CircularDoublyLinkedListStack } from 'lifoer'

import { Queue } from '../../types'

export class CircularDoublyLinkedListStackQueue<T> implements Queue<T> {
  private readonly enqueueStack: CircularDoublyLinkedListStack<T>
  private readonly dequeueStack: CircularDoublyLinkedListStack<T>

  constructor() {
    this.enqueueStack = new CircularDoublyLinkedListStack<T>()
    this.dequeueStack = new CircularDoublyLinkedListStack<T>()
  }
  ...
  toString(): string {
    return 'CircularDoublyLinkedListStackQueue'
  }
}
